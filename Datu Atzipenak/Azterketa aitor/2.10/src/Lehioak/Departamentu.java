...
public class Departamentu extends JFrame {
	...
	public Departamentu() {
		...
		JButton btnInprimaki = new JButton("Inprimaki");
		btnInprimaki.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//DEP_TXOSTENA e1=new DEP_TXOSTENA();
				}
		});
		btnInprimaki.setBounds(36, 216, 117, 25);
		panel.add(btnInprimaki);
	}
