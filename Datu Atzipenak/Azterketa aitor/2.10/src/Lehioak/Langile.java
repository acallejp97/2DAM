...
public class Langile extends JFrame {
	...
	public Langile() throws SQLException{
		...
		btnIrten.setBounds(22, 239, 117, 25);
		panel.add(btnIrten);
		...
		btnGarbitu.setBounds(186, 239, 117, 25);
		...
		btnExtra.setBounds(360, 239, 117, 25);
		panel.add(btnExtra);
		...
		JButton btnInprimakia = new JButton("Inprimakia");
		btnInprimakia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ENP_TXOSTENA e1=new ENP_TXOSTENA();
				System.out.println("hjkhk");
						}	
				});
		btnInprimakia.setBounds(186, 274, 117, 25);
		panel.add(btnInprimakia);
