...
public class Gehitu extends JDialog {
	...
	public Gehitu() {
		...
		
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				Gorde.setActionCommand("Gorde");
				buttonPane.add(Gorde);
				getRootPane().setDefaultButton(Gorde);
			}
			{
				JButton canUtzicelButton = new JButton("Utzi");
				canUtzicelButton.setActionCommand("Utzi");
				buttonPane.add(canUtzicelButton);
			}
		}
	}
	public void gorde(String urte, String hila, String eguna, String ordu, String minutu, 
			String nori, String nork, String titulo, String eduki) {
		
		datuak = new ArrayList<>();
		//Object e = (urte, hila, eguna, ordu, minutu, nori, nork, titulo, eduki);
		//datuak.add(e);
