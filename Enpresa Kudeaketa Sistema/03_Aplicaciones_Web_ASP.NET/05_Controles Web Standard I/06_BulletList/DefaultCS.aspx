...
<body>
    ...
    <div>
        ...
        <asp:BulletedList ID="Lista" runat="server" Width="229px" 
            DisplayMode="LinkButton" OnClick="Lista_Click">
    ...
    <asp:Label ID="etiqueta" runat="server" Text="Label"></asp:Label>
    <br />
    <br />
    <br />
    ...
    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" 
        Height="20px" Width="137px" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
