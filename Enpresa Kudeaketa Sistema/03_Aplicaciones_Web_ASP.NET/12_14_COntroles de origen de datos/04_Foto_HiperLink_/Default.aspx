    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="AccessDataSource1">
            <Columns>
                ...
                <asp:ImageField DataImageUrlField="Foto" DataImageUrlFormatString="~/Imagenes/{0}" HeaderText="FOTOS">
                    <ControlStyle Height="30px" Width="30px" />
                </asp:ImageField>
                <asp:HyperLinkField DataNavigateUrlFields="Url" DataTextField="Url" DataTextFormatString="IR A {0}" />
            </Columns>
        </asp:GridView>
