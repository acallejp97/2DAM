...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Text="Izena:  " CssClass="Etiketa"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" CssClass="Bestela"></asp:TextBox>
&nbsp;<asp:CustomValidator ID="CustomValidator1" runat="server" 
            ControlToValidate="TextBox1" EnableClientScript="False" 
            ErrorMessage="Izen hori ez dago onartuta"></asp:CustomValidator>
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Onartu" CssClass="botonsubmit" />
        <br />
        <br />
