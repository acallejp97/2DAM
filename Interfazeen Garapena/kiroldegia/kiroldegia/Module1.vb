...
Module Module1
    ...
    Sub indibidual()
        ...
        Console.WriteLine(vbNewLine & "Abonu hilabetea " & urte & "ko " & hilabeteak(hil + 1) & "n hasten da" & vbNewLine &
                          izena & "<e>k " & prezioaKalk(abono) & " euro ordaindu behar du" & vbNewLine)
    End Sub
    ...
    Sub kargatu(ByVal ondo)
        ...
        Else
            ...
            For i = 0 To ondo.Length - 2 Step +1
                ...
                Console.WriteLine(izena(i) & vbTab & vbTab & dni(i) & vbTab & mota(i) & vbTab & vbTab & prezioaKalk(mota(i)))
            Next
    ...
    End Sub
    Function prezioaKalk(ByVal mota)
        Dim totala As Double
        Dim prezioa As Double = 350
        Select Case mota.ToUpper
            Case "P"
